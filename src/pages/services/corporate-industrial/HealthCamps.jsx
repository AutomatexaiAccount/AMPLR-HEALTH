...
const HealthCamps = () => {
  ...
  const whatsappMsg = "Hi! I want to enquire about Health Camps services.";
  ...
  return (
    <div className="service-page">
      <Helmet>
        <title>Health Camps | AMPLR Health</title>
      </Helmet>
      ...
      <section className="service-benefits" style={{ padding: '4rem 0', background: '#f8fafc' }}>
        <div className="container" style={{ maxWidth: '800px', margin: '0 auto' }}>
          <h3 style={{ fontSize: '1.4rem', color: 'var(--premium-blue)', marginBottom: '1.5rem', textAlign: 'center' }}>Health Camp Services May Include</h3>
        ...
        <div className="container">
          <div className="pricing-card-wrapper" style={{ maxWidth: '600px', textAlign: 'center', padding: '3rem 2rem', margin: '0 auto' }}>
            ...
            <p style={{ color: '#64748b', fontSize: '1.1rem', marginBottom: '2rem', lineHeight: '1.6' }}>
              Every organisation's requirements are unique. Price will be shared after a detailed discussion regarding your employee strength, location, and healthcare objectives.
            </p>
