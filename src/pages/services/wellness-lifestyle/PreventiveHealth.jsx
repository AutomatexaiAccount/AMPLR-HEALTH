...
const PreventiveHealth = () => {
  ...
  const whatsappMsg = "Hi! I want to enquire about Preventive Health & Wellness services.";
  ...
  return (
    <div className="service-page">
      <Helmet>
        <title>Preventive Health & Wellness | AMPLR Health</title>
        <meta name="description" content="Prevention begins with awareness. Preventive health and wellness coordination by AMPLR Health." />
      </Helmet>
          ...
          <div className="service-hero-inner" style={{ gridTemplateColumns: '1fr', textAlign: 'center', maxWidth: '800px', margin: '0 auto' }}>
            <div>
              <div className="service-hero-badge">
                <Heart size={16} />
                <span>Prevention Begins With Awareness.</span>
              </div>
              <h1 className="service-hero-title">Preventive Health & Wellness</h1>
              <div style={{ background: 'rgba(0,0,0,0.2)', padding: '2rem', borderRadius: '16px', backdropFilter: 'blur(10px)', marginBottom: '2rem', border: '1px solid rgba(255,255,255,0.05)' }}>
                <p className="service-hero-desc" style={{ textAlign: 'left', color: '#cbd5e1' }}>
                  Regular health checks and healthy lifestyle practices can help individuals become more aware of important health parameters and healthcare needs.
                </p>
              </div>
              <div className="service-hero-actions" style={{ justifyContent: 'center' }}>
                <a href={BOOK_SERVICE_LINK} target="_blank" rel="noopener noreferrer" className="btn-primary" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', textDecoration: 'none' }}>
                  <CalendarCheck size={20} /> Explore Preventive Health
                </a>
      ...
      <section className="service-benefits" style={{ padding: '4rem 0', background: '#f8fafc' }}>
        <div className="container" style={{ maxWidth: '800px', margin: '0 auto' }}>
          <h3 style={{ fontSize: '1.4rem', color: 'var(--premium-blue)', marginBottom: '1.5rem', textAlign: 'center' }}>AMPLR HEALTH SERVICES can help coordinate:</h3>
          ...
          <div style={{ marginTop: '3rem', padding: '1.5rem', background: '#fff', borderRadius: '12px', border: '1px solid #e2e8f0', textAlign: 'center', color: '#475569', lineHeight: '1.6', fontWeight: '500' }}>
            Know Your Health. Take Action Early.
          </div>
        </div>
      </section>
