...
const OccupationalTherapy = () => {
  ...
  const whatsappMsg = "Hi! I want to enquire about Occupational Therapy services.";
  ...
  return (
    <div className="service-page">
      <Helmet>
        <title>Occupational Therapy | AMPLR Health</title>
        <meta name="description" content="Building skills for everyday life. Professional occupational therapy by AMPLR Health." />
      </Helmet>
            ...
            <div>
              ...
              <div className="service-hero-actions" style={{ justifyContent: 'center' }}>
                <a href={BOOK_SERVICE_LINK} target="_blank" rel="noopener noreferrer" className="btn-primary" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', textDecoration: 'none' }}>
                  <CalendarCheck size={20} /> Book Occupational Therapy
                </a>
